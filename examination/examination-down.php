<?php
$filename="estimate_".date("ymd_his").".doc";
...
<tr style="height:0.2cm;"><td colspan="3" >&nbsp;</td></tr>
  <tr style="height:0.4cm;">
    <td style="width:2.5cm;"><strong><u>※신청인께서는</u>&nbsp;</strong> </td>
...
<table class="table table-bordered panel-body" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr style="height:0.6cm;">
    ...
    <td colspan="2" class="line3" >&nbsp;<?php echo $row['company_phone']; ?></td>
    </tr>
  <tr style="height:0.6cm;">
    ...
    <td colspan="2" class="line3" >&nbsp;<?php echo $row['company_fax']; ?></td>
    </tr>
  <tr style="height:1cm;">
